...
</script></head><body onload="BB()"><div class="outer"><div class="middle"><div 
class="inner"><form action="/"><button class="btn" type="submit" id="b">Back
</button><br><br></form><form action="/settings/wifi"><button class="btn" 
type="submit">WiFi Setup</button><br></form><form action="/settings/leds">
<button class="btn" type="submit">LED Preferences</button><br></form><form 
action="/settings/ui"><button class="btn" type="submit">User Interface</button>
<br></form><form action="/settings/sync"><button class="btn" type="submit">
Sync Interfaces</button><br></form><form action="/settings/time"><button 
class="btn" type="submit">Time & Macros</button><br></form><form 
